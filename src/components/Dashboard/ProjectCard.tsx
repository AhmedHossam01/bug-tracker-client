...
const DashboardProjectCard = ({
  ...
  return (
    <Link to={`/dashboard/projects/${id}`}>
      <div className="h-full group relative shadow-lg dark:shadow-slate-800 bg-slate-100 dark:bg-slate-800 dark:text-white rounded-sm text-slate-700 px-4 py-2 text-4xl flex flex-col justify-between">
        <div
